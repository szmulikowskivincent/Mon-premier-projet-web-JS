function ajouter() {
  ...
  for (var i = 0; i < longueur; i++) {
    ...
    colonne5.innerHTML +=
      '<button class="btn btn-primary" type="submit" onclick="supprimer(this.parentNode.parentNode.cells[0].innerHTML)"><span class="glyphicon glyphicon-remove"></span> Retirer</button>';
  }
